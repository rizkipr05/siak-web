...
const LoginPegawai = () => {
  ...
  return (
    <div className="min-h-dvh w-full flex items-center justify-center p-4 bg-[#f8fafc] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 rounded-full blur-[120px] opacity-20 transition-colors duration-700 bg-slate-700" />
      ...
      <div className="w-full max-w-100 z-10">
        <div className="bg-white border border-slate-200 rounded-4xl shadow-2xl shadow-slate-200/50 overflow-hidden">
          ...
          <div className="p-8 pb-4 text-center">
            ...
            <h2 className="text-2xl font-black text-slate-800 tracking-tight uppercase">
              Pegawai <span className="text-slate-700">Access</span>
            </h2>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">Sistem Informasi Administrasi</p>
          </div>

          <div className="px-8 mb-6">
            <div className="bg-slate-100 p-3 rounded-2xl flex items-center justify-center gap-2 text-slate-700">
              <Briefcase size={16} />
              <span className="text-[11px] font-black uppercase tracking-wider">Login Pegawai</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="px-8 pb-10 space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 transition-colors group-focus-within:text-slate-700" size={18} />
                <input 
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 transition-colors group-focus-within:text-slate-700" size={18} />
                <input 
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-4.5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] text-white shadow-lg transition-all active:scale-[0.98] mt-4 bg-slate-800 hover:bg-slate-900 shadow-slate-200"
            >
              {loading ? 'MEMPROSES...' : (
                <>
        ...
        <div className="flex items-center justify-center gap-3 mt-6 text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">
          <span>Internal Use Only</span>
          <span>•</span>
          <Link to="/auth/login-admin" className="flex items-center gap-1 text-slate-600 hover:text-indigo-600 transition-colors">
